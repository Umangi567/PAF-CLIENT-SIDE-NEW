...
public class paymentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		doGet(request, response);
				...
				String output =  productObj.insertproduct(request.getParameter("customeraccountNo"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output =productObj.updateproduct( paras.get("customeraccountNo").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = productObj.deleteproduct(paras.get("customeraccountNo").toString()); 
		response.getWriter().write(output);
	}
